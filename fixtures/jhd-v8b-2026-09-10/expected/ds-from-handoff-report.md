...
| Schema | design-system-handoff v8 |
| Exported at | 2026-09-10T20:19:03.960Z |
...
Strategy counts: fixed: 7 · fluid-clamp: 7 · mode-stepped: 47 · viewport-height: 13 · viewport-width: 8.
...
| `--grid-col-start-2` | layout | viewport-width | export | per-mode |
| `--grid-columns` | layout | fixed | export | per-mode |
| `--icon-radius-100` | icon | viewport-width | export | per-mode |
...
| `--text-body-font-size-100` | layout | viewport-height | export | per-mode |
| `--text-body-font-size-200` | layout | viewport-height | export | per-mode |
| `--text-body-font-size-300` | layout | fluid-clamp | export | per-mode |
| `--text-body-letter-spacing-100` | layout | fixed | export | per-mode |
| `--text-body-letter-spacing-200` | layout | viewport-width | export | per-mode |
| `--text-body-letter-spacing-300` | layout | fixed | export | per-mode |
| `--text-body-letter-spacing-400` | layout | viewport-width | export | per-mode |
| `--text-body-paragraph-spacing-100` | layout | viewport-height | export | per-mode |
| `--text-body-paragraph-spacing-200` | layout | viewport-height | export | per-mode |
| `--text-body-paragraph-spacing-300` | layout | fluid-clamp | export | per-mode |
| `--text-title-font-size-100` | layout | viewport-height | export | per-mode |
| `--text-title-font-size-200` | layout | fluid-clamp | export | per-mode |
| `--text-title-letter-spacing-100` | layout | viewport-width | export | per-mode |
| `--text-title-letter-spacing-200` | layout | fixed | export | per-mode |
| `--text-title-letter-spacing-300` | layout | viewport-width | export | per-mode |
| `--text-title-letter-spacing-400` | layout | viewport-width | export | per-mode |
...
| Code | Token | Detail |
| --- | --- | --- |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-1` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-10` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-11` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-12` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-2` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-3` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-4` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-5` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-6` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-7` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-8` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-span-9` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-12` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-2` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-2` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-3` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-4` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-5` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-6` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--grid-col-start-7` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-font-size-100` | `viewport-height` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-font-size-100` | `viewport-height` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-font-size-200` | `viewport-height` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-font-size-200` | `viewport-height` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-letter-spacing-200` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-letter-spacing-200` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-letter-spacing-400` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-letter-spacing-400` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-paragraph-spacing-100` | `viewport-height` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-paragraph-spacing-100` | `viewport-height` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-paragraph-spacing-200` | `viewport-height` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-body-paragraph-spacing-200` | `viewport-height` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-font-size-100` | `viewport-height` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-font-size-100` | `viewport-height` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-100` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-100` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-300` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-300` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-400` | `viewport-width` at layout variant `default` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_CLASS_WITHOUT_FRACTION` | `--text-title-letter-spacing-400` | `viewport-width` at layout variant `flush` with no `responsive.viewport.fraction` and no "N% of screen height|width" description — treated as a hint, per-mode samples emitted unchanged |
| `VIEWPORT_OUTSIDE_GROUPS` | `--grid-col-start-2` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--icon-radius-100` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--text-body-font-size-100` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--text-body-font-size-200` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--text-body-letter-spacing-400` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--text-body-paragraph-spacing-100` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
| `VIEWPORT_OUTSIDE_GROUPS` | `--text-body-paragraph-spacing-200` | states a viewport fraction but sits outside every `viewport.groups` prefix (`device/`) — treated as a hint, per-mode samples emitted unchanged. Correct the class in Figma, or declare the group. |
...
2. **Unresolved units — CLOSED by schema 5, final value CLOSED by schema 6.**
   ...
   generator-side scope heuristic. The residue is §6 UNCONVERTED: 19
