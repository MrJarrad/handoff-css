...
82 of 486 emitted variables carry a class — fixed (export): 7 · fluid-clamp (export): 14 · mode-stepped (export): 52 · viewport-height (description): 8 · viewport-width (description): 1.
